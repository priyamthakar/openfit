...
def test_rout_mask_dtype_bool() -> None:
...
def test_rout_result_has_expected_attributes() -> None:
...
def test_rout_no_outliers_clean_data() -> None:
...
def test_rout_detects_single_outlier() -> None:
...
def test_rout_q_parameter_respected() -> None:
...
def test_rout_outlier_plot_generation() -> None:
...
def test_rout_outlier_plot_distinct_markers() -> None:
...
def test_rout_outlier_plot_with_model_curve() -> None:
    ...
    fig = rout_outlier_plot(
        x, y_mod, result, model_equation=model.equation, model_params=result.clean_params
    )
...
def test_rout_outlier_plot_title_contains_q() -> None:
...
def test_html_report_includes_rout_section_with_outliers() -> None:
...
def test_html_report_excludes_rout_section_without_outliers() -> None:
...
def test_markdown_report_includes_rout_section_with_outliers() -> None:
...
def test_markdown_report_excludes_rout_section_without_outliers() -> None:
