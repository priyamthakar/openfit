...
def test_validate_arrays_passes_clean() -> None:
...
def test_validate_arrays_raises_on_nan() -> None:
...
def test_validate_arrays_raises_on_inf() -> None:
...
def test_validate_arrays_mismatched_lengths() -> None:
...
def test_load_csv_with_missing_values_raises(tmp_path) -> None:
...
def test_load_excel_basic(tmp_path) -> None:
